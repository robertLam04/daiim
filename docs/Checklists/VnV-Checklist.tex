...
\item Avenue rubric
  ...
  \item Custom documents (CDs) should be clearly identified and should be feasible.  The TA
  should have enough information to be able to provide feedback.
  \item A case should be made for why the CDs will improve the project, and
