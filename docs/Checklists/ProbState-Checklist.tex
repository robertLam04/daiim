...
\item The source for the document
  \begin{todolist}
  \item The source is text-based, like \LaTeX{},
  \href{https://en.wikipedia.org/wiki/Markdown} {Markdown},
  \href{https://en.wikipedia.org/wiki/Org-mode} {Emacs Org Mode}, etc.
  \end{todolist}
...
\item Overall qualities of documentation
  ...
  \item Environment (for the users) is clearly identified
  ...
  \item Goals are at the appropriate level; that is, they are not requirements,
  but higher-level statements that will later be refined into requirements
\end{todolist}
