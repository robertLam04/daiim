...
\item MIS Module Classifications
  ...
  \item Syntax for the modules is as specific as it needs to be to implement the
  requirements.  It can be tempting to gloss over details.  The details of
  implementation can be glossed over, but the interface has to be unambiguously
  defined.
  \end{todolist}
...
\item MIS Semantics for each module
  ...
  \item The type is given for all state and environment variables
